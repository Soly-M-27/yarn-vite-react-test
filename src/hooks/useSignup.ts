...
export const useSignup = () => {
    ...
    const signup = async (email:string, password:string, displayName:string, thumbnail:File) => {
      ...
      try {
        ...
        console.log(
          "create storageRef var to access storage and upload the thumbnail path"
        );
        ...
        console.log(
          "displayName before Firebase upload: ",
        ...
        try {
          console.log(
            "trying to create new collection for Firestore Database titled 'users'"
          );
